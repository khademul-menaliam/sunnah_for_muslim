<nav x-data="{ open: false }" class="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 shadow-sm sticky top-0 z-40">
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden space-x-6 sm:-my-px sm:ms-8 sm:flex">
                    ...
                    <x-nav-link :href="route('prayers.tracker')" :active="request()->routeIs('prayers.*')" class="text-sm font-medium">
                        {{ __('Prayers') }}
                    </x-nav-link>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-xl text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 focus:outline-none transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-slate-50 dark:bg-slate-950 border-t border-slate-100 dark:border-slate-900">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('prayers.tracker')" :active="request()->routeIs('prayers.*')">
                {{ __('Daily Prayers') }}
            </x-responsive-nav-link>
